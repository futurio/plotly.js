...
describe('Test colorscale restyle calls:', function() {
    ...
    it('(scatter marker case)', function() {

    });

    it('(scatter marker line case)', function() {

    });

    it('(choropleth case)', function() {

    });

    // TODO how to test heatmaps?
    // how to test parcoords?

    // TODO 'cauto' / 'cmin' / 'cmax'
    // more templates?
